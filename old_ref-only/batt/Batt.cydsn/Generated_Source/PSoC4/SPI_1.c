...
static void SPI_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        SPI_1_spi_mosi_i2c_sda_uart_rx_SetDriveMode((uint8) pinsDm[SPI_1_MOSI_SCL_RX_PIN_INDEX]);

    #if (!SPI_1_CY_SCBIP_V1)
        SPI_1_SET_INP_DIS(SPI_1_spi_mosi_i2c_sda_uart_rx_INP_DIS,
                                     SPI_1_spi_mosi_i2c_sda_uart_rx_MASK,
        ...
        SPI_1_spi_mosi_i2c_sda_uart_rx_wake_SetDriveMode((uint8)
                                                               pinsDm[SPI_1_MOSI_SCL_RX_WAKE_PIN_INDEX]);

        SPI_1_SET_INP_DIS(SPI_1_spi_mosi_i2c_sda_uart_rx_wake_INP_DIS,
                                     SPI_1_spi_mosi_i2c_sda_uart_rx_wake_MASK,
        ...
        SPI_1_spi_miso_i2c_scl_uart_tx_SetDriveMode((uint8) pinsDm[SPI_1_MISO_SDA_TX_PIN_INDEX]);

    #if (!SPI_1_CY_SCBIP_V1)
        SPI_1_SET_INP_DIS(SPI_1_spi_miso_i2c_scl_uart_tx_INP_DIS,
                                     SPI_1_spi_miso_i2c_scl_uart_tx_MASK,
        ...
        SPI_1_spi_sclk_uart_cts_SetDriveMode((uint8) pinsDm[SPI_1_SCLK_PIN_INDEX]);

        SPI_1_SET_INP_DIS(SPI_1_spi_sclk_uart_cts_INP_DIS,
                                     SPI_1_spi_sclk_uart_cts_MASK,
        ...
        SPI_1_spi_ss0_uart_rts_SetDriveMode((uint8) pinsDm[SPI_1_SS0_PIN_INDEX]);

        SPI_1_SET_INP_DIS(SPI_1_spi_ss0_uart_rts_INP_DIS,
                                     SPI_1_spi_ss0_uart_rts_MASK,
