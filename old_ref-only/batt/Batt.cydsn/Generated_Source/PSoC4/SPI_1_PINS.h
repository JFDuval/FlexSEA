...
****************************************/
    ...
    #include "SPI_1_spi_mosi_i2c_sda_uart_rx_wake.h"
#endif /* (SPI_1_MOSI_SCL_RX_WAKE_PIN) */

#if(SPI_1_MOSI_SCL_RX_PIN)
    #include "SPI_1_spi_mosi_i2c_sda_uart_rx.h"
#endif /* (SPI_1_MOSI_SCL_RX_PIN) */

#if(SPI_1_MISO_SDA_TX_PIN)
    #include "SPI_1_spi_miso_i2c_scl_uart_tx.h"
#endif /* (SPI_1_MISO_SDA_TX_PIN_PIN) */

#if(SPI_1_SCLK_PIN)
    #include "SPI_1_spi_sclk_uart_cts.h"
#endif /* (SPI_1_SCLK_PIN) */

#if(SPI_1_SS0_PIN)
    #include "SPI_1_spi_ss0_uart_rts.h"
#endif /* (SPI_1_SS1_PIN) */
...
***************************************/
    ...
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_REG  \
                                                (*(reg32 *) SPI_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_PTR  \
                                                ( (reg32 *) SPI_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_MASK \
                                                (SPI_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM_MASK)
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_POS  \
                                                (SPI_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM_SHIFT)

    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              SPI_1_spi_mosi_i2c_sda_uart_rx_wake__0__INTCFG)
    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              SPI_1_spi_mosi_i2c_sda_uart_rx_wake__0__INTCFG)

    #define SPI_1_INTCFG_TYPE_MASK                  (0x03u)
    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (SPI_1_spi_mosi_i2c_sda_uart_rx_wake__SHIFT)
...
#if(SPI_1_MOSI_SCL_RX_PIN)
    #define SPI_1_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) SPI_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) SPI_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM)
    #define SPI_1_MOSI_SCL_RX_HSIOM_MASK     (SPI_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM_MASK)
    #define SPI_1_MOSI_SCL_RX_HSIOM_POS      (SPI_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM_SHIFT)
#endif /* (SPI_1_MOSI_SCL_RX_PIN) */

#if(SPI_1_MISO_SDA_TX_PIN)
    #define SPI_1_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) SPI_1_spi_miso_i2c_scl_uart_tx__0__HSIOM)
    #define SPI_1_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) SPI_1_spi_miso_i2c_scl_uart_tx__0__HSIOM)
    #define SPI_1_MISO_SDA_TX_HSIOM_MASK     (SPI_1_spi_miso_i2c_scl_uart_tx__0__HSIOM_MASK)
    #define SPI_1_MISO_SDA_TX_HSIOM_POS      (SPI_1_spi_miso_i2c_scl_uart_tx__0__HSIOM_SHIFT)
#endif /* (SPI_1_MISO_SDA_TX_PIN_PIN) */

#if(SPI_1_SCLK_PIN)
    #define SPI_1_SCLK_HSIOM_REG     (*(reg32 *) SPI_1_spi_sclk_uart_cts__0__HSIOM)
    #define SPI_1_SCLK_HSIOM_PTR     ( (reg32 *) SPI_1_spi_sclk_uart_cts__0__HSIOM)
    #define SPI_1_SCLK_HSIOM_MASK    (SPI_1_spi_sclk_uart_cts__0__HSIOM_MASK)
    #define SPI_1_SCLK_HSIOM_POS     (SPI_1_spi_sclk_uart_cts__0__HSIOM_SHIFT)
#endif /* (SPI_1_SCLK_PIN) */

#if(SPI_1_SS0_PIN)
    #define SPI_1_SS0_HSIOM_REG      (*(reg32 *) SPI_1_spi_ss0_uart_rts__0__HSIOM)
    #define SPI_1_SS0_HSIOM_PTR      ( (reg32 *) SPI_1_spi_ss0_uart_rts__0__HSIOM)
    #define SPI_1_SS0_HSIOM_MASK     (SPI_1_spi_ss0_uart_rts__0__HSIOM_MASK)
    #define SPI_1_SS0_HSIOM_POS      (SPI_1_spi_ss0_uart_rts__0__HSIOM_SHIFT)
#endif /* (SPI_1_SS1_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define SPI_1_SET_I2C_SCL_DR(val) \
                            SPI_1_spi_mosi_i2c_sda_uart_rx_Write(val)
    ...
    #define SPI_1_WAIT_SCL_SET_HIGH  (0u == SPI_1_spi_mosi_i2c_sda_uart_rx_Read())
...
/* Unconfigured SCB: sda signal */
    ...
    #define SPI_1_WAIT_SDA_SET_HIGH  (0u == SPI_1_spi_miso_i2c_scl_uart_tx_Read())
