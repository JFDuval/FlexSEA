...
#define PWMH3_DM_ALG_HIZ         (0x00u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_DIG_HIZ         (0x01u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_RES_UP          (0x02u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_RES_DWN         (0x03u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_OD_LO           (0x04u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_OD_HI           (0x05u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_STRONG          (0x06u << PWMH3_DRIVE_MODE_SHIFT)
#define PWMH3_DM_RES_UPDWN       (0x07u << PWMH3_DRIVE_MODE_SHIFT)
