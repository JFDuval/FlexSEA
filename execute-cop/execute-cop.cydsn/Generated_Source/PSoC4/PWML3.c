...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        PWML3_PC =   (PWML3_PC & \
                                (uint32)(~(uint32)(PWML3_DRIVE_MODE_IND_MASK << (PWML3_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (PWML3_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
    uint8 drVal = (uint8)(PWML3_DR & (uint8)(~PWML3_MASK));
    drVal = (drVal | ((uint8)(value << PWML3_SHIFT) & PWML3_MASK));
    PWML3_DR = (uint32)drVal;
}
...
{
	SetP4PinDriveMode(PWML3__0__SHIFT, mode);
}
...
{
    return (uint8)((PWML3_PS & PWML3_MASK) >> PWML3_SHIFT);
}
...
{
    return (uint8)((PWML3_DR & PWML3_MASK) >> PWML3_SHIFT);
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = (uint8)(PWML3_INTSTAT & PWML3_MASK);
		PWML3_INTSTAT = maskedStatus;
        return maskedStatus >> PWML3_SHIFT;
    }
