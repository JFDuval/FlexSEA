...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        PWML2_PC =   (PWML2_PC & \
                                (uint32)(~(uint32)(PWML2_DRIVE_MODE_IND_MASK << (PWML2_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (PWML2_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
    uint8 drVal = (uint8)(PWML2_DR & (uint8)(~PWML2_MASK));
    drVal = (drVal | ((uint8)(value << PWML2_SHIFT) & PWML2_MASK));
    PWML2_DR = (uint32)drVal;
}
...
{
	SetP4PinDriveMode(PWML2__0__SHIFT, mode);
}
...
{
    return (uint8)((PWML2_PS & PWML2_MASK) >> PWML2_SHIFT);
}
...
{
    return (uint8)((PWML2_DR & PWML2_MASK) >> PWML2_SHIFT);
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = (uint8)(PWML2_INTSTAT & PWML2_MASK);
		PWML2_INTSTAT = maskedStatus;
        return maskedStatus >> PWML2_SHIFT;
    }
