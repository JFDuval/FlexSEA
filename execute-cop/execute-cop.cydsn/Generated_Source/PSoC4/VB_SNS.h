...
#define VB_SNS_DM_ALG_HIZ         (0x00u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_DIG_HIZ         (0x01u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_RES_UP          (0x02u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_RES_DWN         (0x03u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_OD_LO           (0x04u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_OD_HI           (0x05u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_STRONG          (0x06u << VB_SNS_DRIVE_MODE_SHIFT)
#define VB_SNS_DM_RES_UPDWN       (0x07u << VB_SNS_DRIVE_MODE_SHIFT)
