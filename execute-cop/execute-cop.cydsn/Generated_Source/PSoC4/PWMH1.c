...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        PWMH1_PC =   (PWMH1_PC & \
                                (uint32)(~(uint32)(PWMH1_DRIVE_MODE_IND_MASK << (PWMH1_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (PWMH1_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
    uint8 drVal = (uint8)(PWMH1_DR & (uint8)(~PWMH1_MASK));
    drVal = (drVal | ((uint8)(value << PWMH1_SHIFT) & PWMH1_MASK));
    PWMH1_DR = (uint32)drVal;
}
...
{
	SetP4PinDriveMode(PWMH1__0__SHIFT, mode);
}
...
{
    return (uint8)((PWMH1_PS & PWMH1_MASK) >> PWMH1_SHIFT);
}
...
{
    return (uint8)((PWMH1_DR & PWMH1_MASK) >> PWMH1_SHIFT);
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = (uint8)(PWMH1_INTSTAT & PWMH1_MASK);
		PWMH1_INTSTAT = maskedStatus;
        return maskedStatus >> PWMH1_SHIFT;
    }
