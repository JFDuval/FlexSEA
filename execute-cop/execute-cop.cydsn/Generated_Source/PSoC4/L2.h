...
#define L2_DM_ALG_HIZ         (0x00u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_DIG_HIZ         (0x01u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_RES_UP          (0x02u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_RES_DWN         (0x03u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_OD_LO           (0x04u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_OD_HI           (0x05u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_STRONG          (0x06u << L2_DRIVE_MODE_SHIFT)
#define L2_DM_RES_UPDWN       (0x07u << L2_DRIVE_MODE_SHIFT)
