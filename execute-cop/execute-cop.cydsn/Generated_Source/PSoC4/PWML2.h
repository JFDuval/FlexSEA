...
#define PWML2_DM_ALG_HIZ         (0x00u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_DIG_HIZ         (0x01u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_RES_UP          (0x02u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_RES_DWN         (0x03u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_OD_LO           (0x04u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_OD_HI           (0x05u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_STRONG          (0x06u << PWML2_DRIVE_MODE_SHIFT)
#define PWML2_DM_RES_UPDWN       (0x07u << PWML2_DRIVE_MODE_SHIFT)
