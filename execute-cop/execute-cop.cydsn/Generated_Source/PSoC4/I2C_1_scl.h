...
#define I2C_1_scl_DM_ALG_HIZ         (0x00u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_DIG_HIZ         (0x01u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_RES_UP          (0x02u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_RES_DWN         (0x03u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_OD_LO           (0x04u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_OD_HI           (0x05u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_STRONG          (0x06u << I2C_1_scl_DRIVE_MODE_SHIFT)
#define I2C_1_scl_DM_RES_UPDWN       (0x07u << I2C_1_scl_DRIVE_MODE_SHIFT)
