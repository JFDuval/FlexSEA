...
# ============================================================================
# State Machine, v2 05/28/2015,  E J Rouse, J F Duval
# v1BBB: Modified for BBB from original versino on RPi
# v2BBB: Modified to support FlexSEA 1.0 commands
...
cproc = Popen(["./plan"], stdin=subprocess.PIPE, stdout=slave)
...
filename = 'Test%i_05282015' % trial_num
