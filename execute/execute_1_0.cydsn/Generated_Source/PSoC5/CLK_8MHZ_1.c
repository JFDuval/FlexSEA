...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_Start
********************************************************************************
*
* Summary:
...
void CLK_8MHZ_1_Start(void) 
{
    ...
    CLK_8MHZ_1_CLKEN |= CLK_8MHZ_1_CLKEN_MASK;
	CLK_8MHZ_1_CLKSTBY |= CLK_8MHZ_1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: CLK_8MHZ_1_Stop
********************************************************************************
*
* Summary:
...
void CLK_8MHZ_1_Stop(void) 
{
    ...
    CLK_8MHZ_1_CLKEN &= (uint8)(~CLK_8MHZ_1_CLKEN_MASK);
	CLK_8MHZ_1_CLKSTBY &= (uint8)(~CLK_8MHZ_1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((CLK_8MHZ_1_CLKEN & CLK_8MHZ_1_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = CLK_8MHZ_1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = CLK_8MHZ_1_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* CLK_8MHZ_1__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(CLK_8MHZ_1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(CLK_8MHZ_1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = CLK_8MHZ_1_GetSourceRegister();
    uint16 oldDivider = CLK_8MHZ_1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = CLK_8MHZ_1_CLKEN & CLK_8MHZ_1_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((CLK_8MHZ_1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(CLK_8MHZ_1_DIV_PTR);
}


/*******************************************************************************
* Function Name: CLK_8MHZ_1_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    CLK_8MHZ_1_MOD_SRC |= modeBitMask & (uint8)CLK_8MHZ_1_MODE_MASK;
}


/*******************************************************************************
* Function Name: CLK_8MHZ_1_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    CLK_8MHZ_1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(CLK_8MHZ_1_MODE_MASK));
}


/*******************************************************************************
* Function Name: CLK_8MHZ_1_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return CLK_8MHZ_1_MOD_SRC & (uint8)(CLK_8MHZ_1_MODE_MASK);
}


/*******************************************************************************
* Function Name: CLK_8MHZ_1_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = CLK_8MHZ_1_GetDividerRegister();
    uint8 oldSrc = CLK_8MHZ_1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        CLK_8MHZ_1_MOD_SRC |= CYCLK_SSS;
        CLK_8MHZ_1_MOD_SRC =
            (CLK_8MHZ_1_MOD_SRC & (uint8)(~CLK_8MHZ_1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return CLK_8MHZ_1_MOD_SRC & CLK_8MHZ_1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: CLK_8MHZ_1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    CLK_8MHZ_1_PHASE = clkPhase & CLK_8MHZ_1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: CLK_8MHZ_1_GetPhase
********************************************************************************
*
* Summary:
...
{
    return CLK_8MHZ_1_PHASE & CLK_8MHZ_1_PHASE_MASK;
}
