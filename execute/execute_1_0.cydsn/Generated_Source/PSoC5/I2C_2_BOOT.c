...
*
* Global variables:
*  I2C_2_slWriteBuf - The global variable used to store a received
*                                command.
*  I2C_2_slReadBuf -  The global variable used to store a response.
...
*
* Global variables:
*  I2C_2_slWriteBuf - The global variable used to store a
*                                received command.
*
*******************************************************************************/
