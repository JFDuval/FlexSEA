...
void I2C_2_Init(void) 
{
    ...
    I2C_2_ADDR_REG = I2C_2_DEFAULT_ADDR;
    ...
    I2C_2_CFG_REG      = I2C_2_DEFAULT_CFG;
    I2C_2_INT_MASK_REG = I2C_2_DEFAULT_INT_MASK;

    /* Enable interrupt generation in status */
    intState = CyEnterCriticalSection();
    I2C_2_INT_ENABLE_REG |= I2C_2_INTR_ENABLE;
...
void I2C_2_Enable(void) 
{
    ...
    CyExitCriticalSection(intState);
        ...
        I2C_2_COUNTER_AUX_CTL_REG |= I2C_2_CNT7_ENABLE;
        CyExitCriticalSection(intState);
    #endif /* (I2C_2_MODE_SLAVE_ENABLED) */
...
*
* Global variables:
*  I2C_2_initVar - This variable is used to check the initial
...
void I2C_2_Stop(void) 
{
...
#if (I2C_2_FF_IMPLEMENTED)
    {
        ...
        blockResetCycles = ((uint16) ((uint16) I2C_2_CLKDIV2_REG << 8u) | I2C_2_CLKDIV1_REG) + 1u;

        /* Disable block */
        I2C_2_CFG_REG &= (uint8) ~I2C_2_CFG_EN_SLAVE;
    ...
    /* Clear busy statuses */
#if (I2C_2_MODE_SLAVE_ENABLED)
    I2C_2_slStatus &= (uint8) ~(I2C_2_SSTAT_RD_BUSY | I2C_2_SSTAT_WR_BUSY);
#endif /* (I2C_2_MODE_SLAVE_ENABLED) */
}
