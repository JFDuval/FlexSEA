      ...
      
{
    ...
    if(NULL != wrData)
    {
        ...
        else if(I2C_1_SM_MSTR_HALT == I2C_1_state)
        {
            ...
            CyIntClearPending(I2C_1_ISR_NUMBER);
        ...
        if(I2C_1_MSTR_NO_ERROR == errStatus)
        {
            ...
            I2C_1_mstrControl = mode;    /* Save transaction mode */
            ...
            I2C_1_EnableInt();   /* Enable intr to complete transfer */
        }
    }
      ...
      
{
    ...
    if(I2C_1_SM_IDLE == I2C_1_state)
    {
        ...
        if(I2C_1_CHECK_BUS_FREE(I2C_1_MCSR_REG))
        {
            I2C_1_DisableInt();  /* Disable ISR for Manual functions */

            slaveAddress = ((uint8) (slaveAddress << I2C_1_SLAVE_ADDR_SHIFT)); /* Set Address */
            ...
            I2C_1_DATA_REG = slaveAddress;   /* Write address to data reg */
        ...
        {
            errStatus = I2C_1_MSTR_BUS_BUSY; /* Bus is busy */
        }
    }
...
/*******************************************************************************
* Function Name: I2C_1_Workaround
********************************************************************************
*
* Summary:
